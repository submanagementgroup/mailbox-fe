...
export const awsConfig = {
  // API Configuration
  apiUrl: 'https://api.submanagementgroup.com/prod', // TODO: Update after API Gateway deployment
  ...
  entra: {
    ...
    redirectUri: 'https://mail.submanagementgroup.com/auth/callback',
  ...
  app: {
    ...
    mailboxDomain: 'funding.submanagementgroup.com',
  },
};
